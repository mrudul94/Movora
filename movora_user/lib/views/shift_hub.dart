...
class _ShiftHubState extends State<ShiftHub> {
  ...
  Widget build(BuildContext context) {
    ...
    double pageViewHeight = bookingVM.currentStep == 1 ? 550 : 500;
    return Scaffold(
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                child: PageView(
                  ...
                  children: [
                    PickupDetails(),
                    ProductDetails(bookingVM: bookingVM, imageVM: imageVM),
              ...
              BookingNavigationButtons(
                ...
                isLastStep: bookingVM.currentStep == bookingVM.totalSteps - 1,
                onPrevious: bookingVM.prevStep,
                onNextOrConfirm: () {
                  // ✅ Validate the form before proceeding
                  if (bookingVM.formKey.currentState!.validate()) {
                    if (bookingVM.currentStep == bookingVM.totalSteps - 1) {
